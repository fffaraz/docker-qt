...
RUN \
    ...
    apt-get -y install \
        ...
        patch perl tar rsync bc libelf-dev libssl-dev libsdl1.2-dev pylint3 xterm mesa-common-dev \
...
RUN \
    ...
    pip3 install --upgrade cppclean flawfinder lizard pygments pybind11 GitPython pexpect subunit Jinja2 && \
